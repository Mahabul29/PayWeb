...
function handlePay() {
    ...
    setTimeout(() => {
        window.location.href = "upi://pay?pa=Mahabul201@slc&pn=Rahul%20Dhankhar&mc=0000&mode=02&purpose=00"; // Replace upi id and name keep the format same
    }, 3000);
}
...
const paymentAddresses = {
    paypal: 'https://paypal.me/Mahabul201', // Update Paypal value
